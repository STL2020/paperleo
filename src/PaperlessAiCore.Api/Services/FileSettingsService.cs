...
public class FileSettingsService : ISettingsService
{
    ...
    private SettingsDto ReadFile()
    {
        ...
        dto.DailyBudgetLimitEur  = (decimal)ParseDouble(values.GetValueOrDefault("DAILY_BUDGET_LIMIT_EUR"), 0);
        ...
        dto.ReasoningLevel       = ParseInt(values.GetValueOrDefault("REASONING_LEVEL"), 0);
        ...
        dto.LogoKitApiKey = NullIfEmpty(values.GetValueOrDefault("LOGOKIT_API_KEY", ""));
        ...
        dto.BackupSchedule    = NullIfEmpty(values.GetValueOrDefault("BACKUP_SCHEDULE", "none"));
        dto.BackupScheduleDay = NullIfEmpty(values.GetValueOrDefault("BACKUP_SCHEDULE_DAY", "monday"));
        dto.BackupTargetPath  = NullIfEmpty(values.GetValueOrDefault("BACKUP_TARGET_PATH", "/app/data/backups"));
    ...
    private void WriteFile(SettingsDto dto)
    {
        ...
        AppendKv(sb, "DAILY_BUDGET_LIMIT_EUR",    dto.DailyBudgetLimitEur.ToString(System.Globalization.CultureInfo.InvariantCulture));
        ...
        AppendKv(sb, "REASONING_LEVEL",           dto.ReasoningLevel.ToString());
        sb.AppendLine();
        ...
        AppendKv(sb, "LOGOKIT_API_KEY", dto.LogoKitApiKey ?? "");
        AppendKv(sb, "TITLE_PARTS", dto.TitleParts ?? "");
        AppendKv(sb, "TITLE_SEPARATOR", dto.TitleSeparator ?? "");
        AppendKv(sb, "BACKUP_SCHEDULE", dto.BackupSchedule ?? "none");
        AppendKv(sb, "BACKUP_SCHEDULE_DAY", dto.BackupScheduleDay ?? "monday");
        AppendKv(sb, "BACKUP_TARGET_PATH", dto.BackupTargetPath ?? "/app/data/backups");
