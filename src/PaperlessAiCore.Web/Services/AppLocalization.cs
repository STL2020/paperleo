...
public static class AppLoc
{
    ...
    private static readonly Dictionary<string, string> DE = new()
    {
        ...
        // Paperless-Backup
        ["plbak.title"]           = "Paperless-ngx Backup",
        ["plbak.subtitle"]        = "Vollständiges Backup aller Dokumente und Metadaten aus Paperless-ngx.",
        ["plbak.start"]           = "Backup starten",
        ["plbak.starting"]        = "Startet …",
        ["plbak.running"]         = "Backup läuft …",
        ["plbak.download"]        = "ZIP herunterladen",
        ["plbak.new"]             = "Neues Backup",
        ["plbak.restore_title"]   = "Metadaten wiederherstellen",
        ["plbak.restore_sub"]     = "Stellt Tags, Korrespondenten, Dokumenttypen und Custom Fields aus einem Backup-ZIP wieder her. PDFs werden nicht zurückgespielt (dafür Paperless-ngx direkt nutzen).",
        ["plbak.restore_btn"]     = "ZIP auswählen & wiederherstellen",
        ["plbak.restore_running"] = "Wird wiederhergestellt …",
        ["plbak.docs"]            = "Dokumente",
        ["plbak.pdfs"]            = "PDFs gesichert",
        ["plbak.size"]            = "ZIP-Größe",
        ["plbak.failed"]          = "Fehler bei",
        ["plbak.warning"]         = "Hinweis: Das Backup lädt alle PDFs aus Paperless herunter. Bei großen Archiven (>1.000 Dokumente) kann das mehrere Minuten dauern. Der Browser-Tab muss geöffnet bleiben.",
    ...
    private static readonly Dictionary<string, string> EN = new()
    {
        ...
        // Paperless Backup
        ["plbak.title"]           = "Paperless-ngx Backup",
        ["plbak.subtitle"]        = "Complete backup of all documents and metadata from Paperless-ngx.",
        ["plbak.start"]           = "Start backup",
        ["plbak.starting"]        = "Starting …",
        ["plbak.running"]         = "Backup running …",
        ["plbak.download"]        = "Download ZIP",
        ["plbak.new"]             = "New backup",
        ["plbak.restore_title"]   = "Restore metadata",
        ["plbak.restore_sub"]     = "Restores tags, correspondents, document types and custom fields from a backup ZIP. PDFs are not restored (use Paperless-ngx directly for that).",
        ["plbak.restore_btn"]     = "Select ZIP & restore",
        ["plbak.restore_running"] = "Restoring …",
        ["plbak.docs"]            = "Documents",
        ["plbak.pdfs"]            = "PDFs backed up",
        ["plbak.size"]            = "ZIP size",
        ["plbak.failed"]          = "Failed",
        ["plbak.warning"]         = "Note: The backup downloads all PDFs from Paperless. For large archives (>1,000 documents) this can take several minutes. The browser tab must remain open.",
